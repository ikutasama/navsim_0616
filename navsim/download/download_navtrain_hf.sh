...
for split in {1..32}; do
    wget --no-check-certificate https://huggingface.co/datasets/OpenDriveLab/OpenScene/resolve/main/navsim/navtrain_current_${split}.tgz
...
for split in {1..32}; do
    wget --no-check-certificate https://huggingface.co/datasets/OpenDriveLab/OpenScene/resolve/main/navsim/navtrain_history_${split}.tgz
