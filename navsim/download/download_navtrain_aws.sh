...
for split in {1..4}; do
    wget --no-check-certificate https://s3.eu-central-1.amazonaws.com/avg-projects-2/navsim/navtrain_current_${split}.tgz
...
for split in {1..4}; do
    wget --no-check-certificate https://s3.eu-central-1.amazonaws.com/avg-projects-2/navsim/navtrain_history_${split}.tgz
